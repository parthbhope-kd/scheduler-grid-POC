...
import { columnDefProject, rowDataProject } from "./projectsData";
import { AgGridReact } from "ag-grid-react";

const NestedGrid = () => {
    let id:number =0;
    const addIDs = React.useCallback(
      (data:any) => {
    ...
    React.useEffect(() => {
      addIDs(rowDataProject);
      console.log(rowDataProject);
...
//     return this.eGui;
//   };
//   let rowDataExpanded: any[];
//   let agGrid;
//   // setup the grid after the page has finished loading
//   document.addEventListener("DOMContentLoaded", function () {
//     var gridDiv: any = document.querySelector("#myGrid");
//     agGrid = new Grid(gridDiv, gridOptions);
...
//   }
  return (
    ...
    >
      NestedGrid
      <AgGridReact rowData={rowDataProject} columnDefs={columnDefProject}>
